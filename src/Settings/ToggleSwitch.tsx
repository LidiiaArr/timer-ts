...
import {setAutoStartTC, setWorkMinutesTC} from "../redux/timer-reducer";
...
export const ToggleSwitch = (props: any) => {
    ...
    return (
        <div className={'checkbox-container'} {...props}>
            ...
            <input type="checkbox" id="switch" checked={autoStart} onChange={(e:ChangeEvent<HTMLInputElement>)=> {toggleHandler(e)}}/><label className={'checkbox'} htmlFor="switch">Toggle</label>
